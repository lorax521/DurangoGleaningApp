    DROP FUNCTION IF EXISTS upsertLeafletData(int[], text[], text[], text[], text[], text[]);
    ...
    sql := 'WITH n(cartodb_id,the_geom, type, count, permission, notes) AS (VALUES ';
    ...
    || 'INSERT INTO durango (the_geom, type, count, permission, notes)'
    || 'SELECT n.the_geom, n.type, n.count, n.permission, n.notes FROM n WHERE n.cartodb_id < 0 AND '
    ...
    GRANT EXECUTE ON FUNCTION upsertLeafletData(integer[],text[], text[], text[], text[], text[]) TO publicuser;